...
const operations = new Set(['initial', 'navigate', 'back', 'reload', 'copy', 'settings-open', 'settings-save', 'extension-select', 'plugin-catalog', 'plugin-picker-open', 'plugin-add', 'plugin-action']);
